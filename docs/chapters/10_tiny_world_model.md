...
- [Chapter 09 — Differentiable physics](09_differentiable_physics.md) (learning dynamics parameters)
- DreamerV3 — general world-model RL

## Next

→ [Chapter 11 — Information geometry](11_information_geometry.md)

Full index: [10 Tiny Math Engines](../chapters.md)
